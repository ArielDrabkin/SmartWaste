...
#
SmartWaste is a project that was developed as part of the "Smart-Cities" Hackathon held for 36 hours by ITC (Israeli Tech Challenge). SmartWaste secured 2nd place in the competitions. The objective of the project is to implement an image recognition feature that allows users to take a photo of an item and receive instant feedback on whether it is recyclable or not and in which bin it should be disposed.
